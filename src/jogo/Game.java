...
public class Game extends Canvas implements Runnable {
	...
	public void tick() {
		if ((p.getX() < 30 && p.getY() < 26 && p.isPlataforma() && faseAtual == 1) || p.isMorreu()) {
			...
			plat2.setX(523);
			plat2.setY(323);
			plat2.setLargura(126);
			plat3.setX(456);
			plat3.setY(293);
			plat3.setLargura(38);
			plat4.setX(523);
			plat4.setY(259);
			plat4.setLargura(126);
			plat5.setX(430);
			plat5.setY(234);
			plat5.setLargura(58);
			plat6.setX(523);
			plat6.setY(201);
			plat6.setLargura(126);
			plat7.setX(523);
			plat7.setY(147);
			plat7.setLargura(126);
			plat8.setX(587);
			plat8.setY(171);
			plat8.setLargura(62);
			plat9.setX(587);
		...
		if ((p.getX() < 50 && p.getY() < 50 && p.isPlataforma() && faseAtual == 2) || p.isMorreu()) {
			...
			plat2.setX(170);
			plat2.setY(318);
			plat2.setLargura(200);
			plat3.setX(380);
			plat3.setY(285);
			plat3.setLargura(95);
			plat4.setX(175);
			plat4.setY(232);
			plat4.setLargura(160);
			plat5.setX(45);
			plat5.setY(178);
			plat5.setLargura(100);
			plat6.setX(175);
			plat6.setY(150);
			plat6.setLargura(160);
			plat7.setX(350);
			plat7.setY(110);
			plat7.setLargura(100);
			plat8.setX(470);
			plat8.setY(70);
			plat8.setLargura(180);
			plat9.setX(0);
			plat9.setY(0);
			plat9.setLargura(0);
			plat10.setX(0);
		...
		if ((p.getX() > 588 && p.getY() < 71 && p.isPlataforma() && faseAtual == 3) || p.isMorreu()) {
			...
			plat2.setX(315);
			plat2.setY(295);
			plat2.setLargura(335);
			plat3.setX(0);
			plat3.setY(262);
			plat3.setLargura(260);
			plat4.setX(170);
			plat4.setY(233);
			plat4.setLargura(80);
			plat5.setX(0);
			plat5.setY(174);
			plat5.setLargura(260);
			plat6.setX(170);
			plat6.setY(145);
			plat6.setLargura(80);
			plat7.setX(0);
			plat7.setY(85);
			plat7.setLargura(260);
			plat8.setX(300);
			plat8.setY(125);
			plat8.setLargura(350);
			plat9.setX(0);
			plat9.setY(0);
			plat9.setLargura(0);
			plat10.setX(0);
		...
		if ((p.getX() < 40 && p.getY() < 94 && p.isPlataforma() && faseAtual == 4)) introducao = 4;
	...
	public void render() {
		...
		for (int j = 0; j < item.length; j++)
			if (renderizaitem[j]) item[j].render(g);
		g.fillRect(Mouse.getX() - 2, Mouse.getY() - 2, 4, 4);
		p.render(g);
		for (int j = 0; j < inimigo.length; j++)
			if (!inimigo[j].morto) inimigo[j].render(g);
		if (faseAtual == 0) g.drawImage(menu, 0, 0, getWidth(), getHeight(), this);
		if (introducao == 1) {
			...
			if (o >= 90) introducao = 2;
		}

		if (faseAtual == 1) g.drawImage(setaEsquerda, 0, 25, 43, 46, this);
		if (faseAtual == 2) {
		...
		if (introducao == 4) g.drawImage(fim, 0, 0, getWidth(), getHeight(), this);
		g.dispose();
		bs.show();
	}
	...
	public void keyPressed(KeyEvent e) {
		...
		if (key == KeyEvent.VK_RIGHT) {
			p.setDireita(true);
			if (p.isPermiteTiro()) p.setDirecao(0);
		}
		else if (key == KeyEvent.VK_LEFT) {
			p.setEsquerda(true);
			if (p.isPermiteTiro()) p.setDirecao(1);
		}
